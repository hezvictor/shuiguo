...
class FallingThings(StereoDataset):
    def __init__(self, aug_params=None, root='/data2/cjd/data_wxq/fallingthings'):
        ...
        image1_list = sorted(glob(root + '/*/*/*right.jpg'))
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='C:\\Users\\32673\PycharmProjects\MonSter-main\datasets\kitti', image_set='training'):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)

        # root_12 = 'C:\\Users\\32673\PycharmProjects\MonSter-main\datasets\kitti'
        ...
        root_15 = 'C:\\Users\\32673\PycharmProjects\MonSter-main\datasets\kitti'
...
class VKITTI2(StereoDataset):
    def __init__(self, aug_params=None, root='/my_data/cjd/stereo_dataset/vkitti2/'):
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/data2/cjd/StereoDatasets/middlebury', split='2014', resolution='F'):
        ...
        if split == "2005":
            ...
            scenes = list((Path(root) / "2021/my_data").glob("*"))
            for scene in scenes:
...
def fetch_dataloader(args):
    """ Create the my_data loader for the corresponding trainign set """
